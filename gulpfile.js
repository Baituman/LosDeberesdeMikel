...
// <---------------------- comentamos rutas a todos los archivos de conf del gulp file ---------------------------------->
// const sassFiles = 'src/sass/**/*.sass';
// const jsFiles = 'src/js/**/*.js';
// const htmlFiles = 'src/html/**/*.html';
// <---------------------- cargamos solo la pagina iris en el gulpfile ---------------------------------->
const sassFiles = 'src/sass/**/iris.sass'
const jsFiles = 'src/js/**/iris.js';
const htmlFiles = 'src/html/**/iris.html'
// <---------------------- continuamos la carga del resto de archivos necesarios en el gulpfile ---------------------------------->
